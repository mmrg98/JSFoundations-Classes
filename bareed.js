...
class Customer extends Person{
  ...
  _isInRange = vendor => {
    return (this.location.distanceTo(vendor.location) <=vendor.range || this.location.equals(vendor.location) || this.location.distanceTo(vendor.location) <= (vendor.range* -1))
  }
